...
import lovehan1me.video.ui.ic_arrow_back
import lovehan1me.video.ui.ic_heart
import lovehan1me.video.ui.ic_heart_outline
import lovehan1me.video.ui.ic_more_vert
        ...
        Box(
                    ...
                    .background(
                        Brush.verticalGradient(
                            colors = listOf(
                                ...
                                PlayerTokens.Overlay.scrimTopStart,
                            )
                        )
                    )
            )
            TopAppBar(
                ...
                navigationIcon = {
                    IconButton(onClick = onBackClick) {
                        Icon(
                            ...
                            modifier = Modifier.size(PlayerTokens.PlayerSizes.iconLarge)
                        )
                    }
                },
                actions = {
                    ...
                    if (isFullscreen) {
                        ...
                        Column(
                            ...
                            Text(
                                text = deviceTime,
                                color = PlayerTokens.Overlay.textTertiary,
                ...
                colors = TopAppBarDefaults.topAppBarColors(
                    ...
                    navigationIconContentColor = PlayerTokens.Overlay.onScrim,
                    titleContentColor = PlayerTokens.Overlay.textPrimary,
                    actionIconContentColor = PlayerTokens.Overlay.onScrim,
                ),
...
private fun TopBarTitleText(text: String) {
    ...
    Box {
        ...
        Text(
            text = text,
            color = PlayerTokens.Overlay.textPrimary,
            style = baseStyle,
            maxLines = 1,
            overflow = TextOverflow.Ellipsis,
        )
