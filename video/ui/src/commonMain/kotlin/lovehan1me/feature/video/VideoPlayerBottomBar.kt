...
import lovehan1me.video.ui.auto_play_next_short
import lovehan1me.video.ui.ic_fullscreen
import lovehan1me.video.ui.ic_fullscreen_exit
import lovehan1me.video.ui.ic_pause
import lovehan1me.video.ui.ic_play_arrow
import lovehan1me.video.ui.ic_skip
...
import lovehan1me.video.ui.player_speed_format
import lovehan1me.video.ui.speed
import lovehan1me.video.ui.switch_off
import lovehan1me.video.ui.switch_on
                ...
                modifier = Modifier
                    ...
                    .background(
                        Brush.verticalGradient(
                            colors = listOf(
                                PlayerTokens.Overlay.scrimBottomStart,
            ...
            Column(
                ...
                if (expanded) {
                    ...
                    Row(
                        modifier = Modifier
                            .fillMaxWidth()
                            .height(PlayerTokens.PlayerSizes.bottomControlRow)
                        ...
                        Row(verticalAlignment = Alignment.CenterVertically) {
                            IconButton(onClick = onPlayClick) {
                                Icon(
                                    ...
                                    contentDescription = null,
                                    tint = PlayerTokens.Overlay.onScrim,
                                    modifier = Modifier.size(PlayerTokens.PlayerSizes.bottomPrimaryIcon)
                                )
                            }
                            if (onNextClick != null) {
                                IconButton(onClick = onNextClick) {
                        ...
                        if (fullscreenEnabled) {
                            IconButton(onClick = onFullscreenClick) {
                                Icon(
                                    ...
                                    contentDescription = null,
                                    tint = PlayerTokens.Overlay.onScrim,
                                    modifier = Modifier.size(PlayerTokens.PlayerSizes.bottomSecondaryIcon)
                                )
                            }
                        }
                    }
...
private fun PlayerTimeText(currentTime: String, totalTime: String) {
    ...
    fun StrokedText(text: String, fill: Color) {
        Box {
            Text(
                text = text,
                color = PlayerTokens.Overlay.backdrop,
    ...
    Row(verticalAlignment = Alignment.CenterVertically) {
        StrokedText(text = currentTime, fill = PlayerTokens.Overlay.onScrim)
        StrokedText(
            text = " / $totalTime",
            fill = PlayerTokens.Overlay.onScrim.copy(alpha = 0.618f),
        )
    }
}
