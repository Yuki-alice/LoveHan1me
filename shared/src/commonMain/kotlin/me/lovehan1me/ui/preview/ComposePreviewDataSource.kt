...
package me.lovehan1me.ui.preview
...
import me.lovehan1me.logic.model.DownloadItemNode
...
import me.lovehan1me.ui.screen.home.homepage.HomeCategory
...
val fakeDownloadedVideos = fakeHomePageVideos.take(3).mapIndexed { index, item ->
    VideoWithCategories(
        video = HanimeDownloadEntity(
            ...
            state = me.lovehan1me.logic.state.DownloadState.Finished,
            id = index + 1,
        ),
...
val fakeVideoIntroduction = HanimeVideo(
    ...
    views = "137.6万次",
    videoUrls = me.lovehan1me.HanimeResolution().apply {
