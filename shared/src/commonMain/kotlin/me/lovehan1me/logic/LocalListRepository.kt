...
import me.lovehan1me.logic.dao.LocalListDao
import me.lovehan1me.logic.dao.LocalPlaylistRow
import me.lovehan1me.logic.entity.LocalListEntity
import me.lovehan1me.logic.entity.LocalListItemEntity
import me.lovehan1me.logic.model.HanimeInfo
import me.lovehan1me.logic.model.HanimeVideo
import me.lovehan1me.logic.model.ListItemExport
import me.lovehan1me.logic.model.ListsExport
import me.lovehan1me.logic.model.PlaylistExport
import me.lovehan1me.logic.model.Playlists
import kotlinx.coroutines.flow.Flow
import kotlinx.coroutines.flow.map
import kotlinx.serialization.json.Json
import me.lovehan1me.logic.randomUUIDString
/**
...
object LocalListRepository {
    ...
    suspend fun createPlaylist(title: String, desc: String): Playlists.Playlist {
        ...
        val code = "local_" + randomUUIDString().replace("-", "")
        dao.upsertPlaylist(
            LocalListEntity(
                listCode = code,
                kind = PLAYLIST_KIND,
