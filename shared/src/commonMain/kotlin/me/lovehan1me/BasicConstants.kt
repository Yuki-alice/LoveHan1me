...
val SEARCH_YEAR_RANGE_END: Int get() = Instant.fromEpochMilliseconds(me.lovehan1me.logic.currentEpochMillis()).toLocalDateTime(TimeZone.currentSystemDefault()).year
