...
import me.lovehan1me.alternative
import me.lovehan1me.custom
import me.lovehan1me.custom_mirror_site_test_failed
import me.lovehan1me.custom_mirror_site_test_failed_http
import me.lovehan1me.custom_mirror_site_test_parse_failed
import me.lovehan1me.custom_mirror_site_test_partial_success
import me.lovehan1me.custom_mirror_site_test_success
import me.lovehan1me.custom_mirror_site_watch_test_failed
import me.lovehan1me.custom_mirror_site_watch_test_failed_http
import me.lovehan1me.default_
import me.lovehan1me.direct
import me.lovehan1me.doh_conflict_message
import me.lovehan1me.doh_disabled_summary
import me.lovehan1me.http_proxy
import me.lovehan1me.invalid_ip_or_port
import me.lovehan1me.loading
import me.lovehan1me.node_latency_sum
import me.lovehan1me.socks_proxy
import me.lovehan1me.system_proxy
import me.lovehan1me.unknow
import me.lovehan1me.warning
import me.lovehan1me.restart_or_not_working
import me.lovehan1me.network_timeout_text
import me.lovehan1me.mpv_socks5_warning
import me.lovehan1me.domain_change_tips
import me.lovehan1me.doh_conflict_message
import me.lovehan1me.custom_mirror_site_warning
import me.lovehan1me.custom_mirror_site_testing
import me.lovehan1me.custom_mirror_site_invalid
...
import me.lovehan1me.logic.network.HDns
import me.lovehan1me.logic.network.HProxySelector
import me.lovehan1me.logic.network.HanimeNetwork
import me.lovehan1me.logic.network.ServiceCreator
import me.lovehan1me.logic.state.WebsiteState
import me.lovehan1me.logout
import me.lovehan1me.ui.component.ConfirmDialog
import me.lovehan1me.ui.screen.settings.DelayResultUi
import me.lovehan1me.ui.screen.settings.DohTestResultUi
import me.lovehan1me.ui.screen.settings.NetworkSettingsScreen
import me.lovehan1me.ui.screen.settings.NetworkSettingsUiState
...
actual fun NetworkSettingsRouteScreen(embedded: Boolean) {
    ...
    NetworkSettingsScreen(
        ...
        onApplyProxy = { type, ip, port ->
            ...
            coroutineScope.launch {
                SettingsRepository.update { it.copy(proxyType = me.lovehan1me.logic.model.ProxyType.fromId(type), proxyIp = ip, proxyPort = port) }
