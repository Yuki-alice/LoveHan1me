package me.lovehan1me.ui.navigation.settings
...
import me.lovehan1me.HanimeConstants
import me.lovehan1me.HA1_GITHUB_FORUM_URL
import me.lovehan1me.HA1_GITHUB_ISSUE_URL
import me.lovehan1me.logic.BackupManager
import me.lovehan1me.logic.SettingsRepository
import me.lovehan1me.logic.platform.appVersionDisplay
import me.lovehan1me.logic.platform.applyAppLanguage
import me.lovehan1me.logic.platform.applySecureMode
import me.lovehan1me.logic.platform.clearCacheDir
import me.lovehan1me.logic.platform.getCacheDirSize
import me.lovehan1me.logic.platform.isDeviceSecure
import me.lovehan1me.logic.platform.isPipPermissionGranted
import me.lovehan1me.logic.platform.openPipPermissionSettings
import me.lovehan1me.logic.platform.recreateActivity
import me.lovehan1me.logic.platform.readBackupText
import me.lovehan1me.logic.platform.restartApp
import me.lovehan1me.logic.platform.supportsPerAppLinks
import me.lovehan1me.logic.platform.switchLauncherIcon
import me.lovehan1me.ui.viewmodel.updateCheckInWidget
import me.lovehan1me.logic.platform.writeBackupText
import me.lovehan1me.logic.currentEpochMillis
import me.lovehan1me.logic.platform.openPerAppLinksSettings
import me.lovehan1me.logic.platform.rememberBackupExportLauncher
import me.lovehan1me.logic.platform.rememberBackupImportLauncher
import me.lovehan1me.ui.viewmodel.updateCheckInWidget
import me.lovehan1me.Res
import me.lovehan1me.action_app_open_by_default_settings_not_support
import me.lovehan1me.backup_export_failed
import me.lovehan1me.backup_export_success
import me.lovehan1me.backup_import_failed
import me.lovehan1me.backup_import_success
import me.lovehan1me.cache_empty
import me.lovehan1me.clear_failed
import me.lovehan1me.clear_success
import me.lovehan1me.current_version
import me.lovehan1me.fake_icon_hint
import me.lovehan1me.follow_system
import me.lovehan1me.local_data_export_failed
import me.lovehan1me.local_data_export_success
import me.lovehan1me.local_data_import_failed
import me.lovehan1me.local_data_import_success
import me.lovehan1me.login_first
import me.lovehan1me.not_set_sys_lock
import me.lovehan1me.online_data_export_failed
import me.lovehan1me.online_data_export_success
import me.lovehan1me.online_data_import_failed
import me.lovehan1me.online_data_import_success
import me.lovehan1me.request_pip_alert
import me.lovehan1me.simplified_chinese
import me.lovehan1me.success_value
import me.lovehan1me.sure_to_clear_cache
import me.lovehan1me.traditional_chinese
import me.lovehan1me.sure_to_clear
import me.lovehan1me.restart_needed
import me.lovehan1me.hanime_app_name
import me.lovehan1me.go_to_settings
...
import me.lovehan1me.backup_import_confirm_message
import me.lovehan1me.attention
import me.lovehan1me.apply_deep_links_tips
import me.lovehan1me.apply_deep_links_summary
import me.lovehan1me.apply_deep_links
import me.lovehan1me.app_name_fake_xxt
import me.lovehan1me.app_name_fake_cornhub
import me.lovehan1me.app_name_fake_calc
import me.lovehan1me.ic_launcher_xxt
import me.lovehan1me.ic_launcher_new
import me.lovehan1me.ic_launcher_cornhub
import me.lovehan1me.ic_launcher_calc
import me.lovehan1me.logic.LocalListRepository
import me.lovehan1me.logic.OnlineListsBackup
import me.lovehan1me.logic.model.AppLanguage
import me.lovehan1me.logic.model.DisplayDensity
import me.lovehan1me.logic.model.PaletteStyle
import me.lovehan1me.logic.model.ThemeAccent
import me.lovehan1me.logic.model.ThemeMode
import me.lovehan1me.logic.model.VideoLandscapeLayoutStyle
import me.lovehan1me.ui.component.ConfirmDialog
import me.lovehan1me.ui.screen.settings.HomeSettingsPage
import me.lovehan1me.ui.screen.settings.HomeSettingsScreen
import me.lovehan1me.ui.screen.settings.model.HomeSettingsUiState
import me.lovehan1me.ui.screen.home.homepage.defaultHomeCategoryPreferenceItems
import me.lovehan1me.ui.screen.home.homepage.hiddenHomeCategoryKeys
import me.lovehan1me.ui.screen.home.homepage.homeCategoryOrder
import me.lovehan1me.ui.screen.home.homepage.saveHomeCategoryPreferences
    ...
    val launcherItems = remember {
        listOf(
            LauncherItem(
                ...
                alias = "me.lovehan1me.LauncherAliasDefault",
            ),
            LauncherItem(
                name = fakeNameCalc,
                iconRes = Res.drawable.ic_launcher_calc,
                alias = "me.lovehan1me.LauncherFakeCalc",
            ),
            LauncherItem(
                name = fakeNameCornhub,
                iconRes = Res.drawable.ic_launcher_cornhub,
                alias = "me.lovehan1me.LauncherFakeCornhub",
            ),
            LauncherItem(
                name = fakeNameXXT,
                iconRes = Res.drawable.ic_launcher_xxt,
                alias = "me.lovehan1me.LauncherFakeXxt",
            ),
        )
    }
